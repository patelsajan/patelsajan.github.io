...
let DataService = class DataService {
    ...
    getCountryData(countrySlug) {
        return this.http.get("https://api.covid19api.com/dayone/country/" + countrySlug);
    }
};
...
const APIkey = "85e122dea1e14932864d8a8be2b70667";
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./key */ "./src/app/key.ts");
...
let NewsService = class NewsService {
    constructor(http) {
        this.http = http;
        this.url = "https://cors-anywhere.herokuapp.com/https://newsapi.org/v2/everything?q=covid19 OR covid-19 OR coronavirus&language=en&pageSize=100&sortBy=popularity&page=1"; //&apiKey="+APIkey;
        this.option = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'x-requested-with': 'patelsajan.github.io',
                'X-Api-Key': _key__WEBPACK_IMPORTED_MODULE_3__["APIkey"]
            })
        };
    }
    getNews() {
    ...
    countryNews(country) {
        console.log(country);
        return this.http.get("https://newsapi.org/v2/top-headlines?country=" + country + "&apiKey=" + _key__WEBPACK_IMPORTED_MODULE_3__["APIkey"] + "&language=en");
    }
};
